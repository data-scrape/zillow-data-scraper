#!/usr/bin/env python3
"""
Zillow Data Scraper - Scrape Zillow property data - prices, addresses, Zestimate
Open source scraper for zillow data scraper, zillow scraper, scrape zillow data
...
class ZillowDataScraperScraper:
    """Scraper for Zillow Data Scraper."""
...
def main():
    parser = argparse.ArgumentParser(description="Zillow Data Scraper - Scrape Zillow property data - prices, addresses, Zestimate")
    ...
    scraper = ZillowDataScraperScraper(proxy=args.proxy)
